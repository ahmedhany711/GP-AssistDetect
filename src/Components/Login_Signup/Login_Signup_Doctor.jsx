...
const LoginSignupDoctor = () =>
{
    ...
    const handleLogin = async (e) =>
    {
        ...
        try {
            const response = await fetch(
                "https://b7a2-102-40-210-151.ngrok-free.app/api/doctor/sign-in",
                {
                    method: "POST",
                    headers: {
    ...
    const handleSignUp = async (e) =>
    {
        ...
        try {
            const response = await fetch(
                "https://b7a2-102-40-210-151.ngrok-free.app/api/doctor/sign-up",
                {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                ...
                <div data-aos="fade-up" className="max-w-xl w-full space-y-8">
                    ...
                    <div>
                        <h2 className="font-headingFont mt-6 text-center text-5xl font-extrabold text-nav ">
                            {isSignUp ? "Sign Up as Doctor" : "Log In as Doctor"}
                        </h2>
                    </div>
...
export default LoginSignupDoctor;
